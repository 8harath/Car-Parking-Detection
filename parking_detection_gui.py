...
import numpy as np
from parking_detection_core import ParkingDetectionCore
...
class ParkingDetectionGUI(QMainWindow):
    ...
    def load_video(self):
        ...
        if file_name:
            ...
            self.detector = ParkingDetectionCore(video_path=file_name)
    ...
    def load_image(self):
        ...
        if file_name:
            ...
            self.detector = ParkingDetectionCore(image_path=file_name)
            self.update_frame()
